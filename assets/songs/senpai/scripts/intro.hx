...
function onCutscene() {
    var lunchbox = FlxG.sound.play(Paths.music('ingame/weeb/Lunchbox'), 0, true);
    ...
    new FlxTimer().start(0.3, t -> {
		...
		if (blackScreen.alpha > 0) t.reset(0.3);
            ...
            game.openDialogueBox("senpai", CoolUtil.coolTextFile(Paths.txt('dialogue/senpaiDialogue')), () -> {
